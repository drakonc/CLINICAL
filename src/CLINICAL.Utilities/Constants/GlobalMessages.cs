namespace CLINICAL.Utilities.Constants
{
    public class GlobalMessages
    {
        ...
        public const string MESSAGE_ERROR_SAVE = "No se pudo registrar.";
        ...
        public const string MESSAGE_ERROR_UPDATE_STATE = "No se pudo actualizó el estado.";
        public const string MESSAGE_DELETE = "Se eliminó correctamente.";
        public const string MESSAGE_ERROR_DELETE = "No se pudo eliminar.";
